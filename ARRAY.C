...
It is second data storage technique
It allocates contigeos memory blocks.
...
1. Declare The Array
   ...
   Example: int a[5]; // a has 5 element  one int need 2 bytes
